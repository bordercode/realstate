--- 
title: "Uncovering us Housing market fluctuations and internal migration patterns using Posit interactive mapping libraries."
date: "`r Sys.Date()`"
...
colorlinks: yes
graphics: yes
description: "This research explores the relationship between fluctuations in housing market prices and internal migration trends. It offers a contemporary characterization of the economic conditions prevalent in metropolitan areas across the United States and delves into the emerging forces shaping the real estate industry today at a regional scale. There is a particular emphasis on strategic areas of the country, such as the US-Mexico border. Interactive display and visualization is a center element of the book analysis strategy."
...
This is the online site of the book *Using Posit interactive mapping libraries to uncover current Housing market fluctuations and internal migration patterns.*
...
- Enjoy the read by purchasing a copy at: [geoinsight]()
...
While the manufacturing industrial sector demand for warehouse space for instance, has been a key driver of commercial land prices in these border urban areas, until recently, less understood were Mexico´s northern border cities, residential housing patterns. 
