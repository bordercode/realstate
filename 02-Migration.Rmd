...
Several impacts and social process are influenced by housing market conditions and population movements across states. One such key issue of social concern is homelessness, this is a major problem that has been raising in the US particularly in some expensive Metropolitan areas.
Is a phenomena that has been gaining attention from the public policy perspective as well. From the academic arena, many authors, including sociologist, economist, urban planners, geographers, psychologist, anthropologist or public health practitioners, are currently working to provide answers to an issue that reflects the inequalities of today´s society.

With no doubt, the topic is complex and multifaceted, none the less is indeed a relevant subject that needs to be addressed, if the current affordability crisis as depicted by the growing gaps in variables such as income to house price ratios or rent prices, should be understood.
