...
```
Source: José Lus Manzanars rivera base on data from Federal Housing Finance Agency  [@fhfaHousePriceIndex2022, @bureauofeconomicanalysisPersonalIncomeCounty2023]
...
In addition, empirical evidence from the American Community Survey (ACS), internal migration flows, indicate that California is a leading state concerning negative migration flows and has been consistently experiencing negative net flows in its main Metropolitan areas.
...
In light of the previous research question, Figure 4 provides an analysis of the distribution of destination states for Californians, based on a classification of housing market affordability. 

This scale encompasses four distinct categories that correspond to the distribution of the regional price parity (RPP) indicator across states. The reference values for these categories are as follows: "High cost" (RPP > 125), "Expensive" (125 >= RPP > 110), "Affordable" (110 >= RPP > 70), and "Low cost" (RPP < 70). By employing this classification framework, we can gain valuable insights into the varying degrees of housing affordability among destination states.
...
The main destinations Metroolitan areas during the study period were:  Phoenix-Mesa-Chandler, AZ, Las Vegas-Henderson-Paradise, NV, Boise City, ID,  Denver-Aurora-Lakewood, CO and Houston-The Woodlands-Sugar Land, TX. Whereas the top local (within state) destinations were:  Riverside-San Bernardino-Ontario, 
Sacramento-Roseville-Folsom, San Francisco-Oakland-Berkeley, Stockton and Bakersfield Metro areas.
^[Interesting to note in the case of Riverside-San Bernardino-Ontario Metro area, it is a periphery location to Los Angeles, Which may indicate a price-out effect from the more expensive Los Angeles-Long Beach-Anaheim Metro Area].
