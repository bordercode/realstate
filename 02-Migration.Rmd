...
Data on US population growth, shows that cities with more educated residents have grown faster than comparable cities with less human capital[@glaeser2004rise]. This environment, in turn creates a cycle where some areas of the country are more attractive to specific population groups[@choi2021wage] and at the same time generate incentives to migrate for particular demographic segments as they are being priced-out of the housing market. 
