...
Although Border MSA  are not particularly important destinations for in migration considering the total population,  San Diego-Chula Vista-Carlsbad is the only MSA that is part of the top 20 MSA´s by its magnitude of inflows in the country. 
...
We find that 70% of the MSA where the majority of Hispanic population migrated to,  are located in the border with México.  The highest recipient being McAllen-Edinburg-Mission, followed by Brownsville-Harlingen and  Laredo, all of theme in the Texas Lower Rio grande region. a low cost low income, High poverty rate area.

Interestingly from the above information we find a pattern Comprised of MSA´s where the common feature is a particular labor market suited for unskilled workforce. 

In this pattern we have Dalton, Georgia, Yakima Washington and Grand Island, Nebraska. 

Dalton is an area home of the nation's floor-covering manufacturers hub and often referred as the *Carpet Capital of the World*. This is a metropolitan area with a demographic structure with a majority Hispanic population, a feature that is indeed unique out of the border state region. 

As the case above, Yakima Metropolitan Statistical Area (MSA), situated within the state of Washington, is another region out of the US-Mexico border that make up the top 20 destinations for Hispanics migrating out of state. 
...
To explore this interesting questions, we estimate the Location Quotient (LQ) for the main racial categories included in the ACS. 
...
mapa<-mapview(asians_df, map.types =  "OpenStreetMap.DE",cex="lq", zcol="lq", layer.name= "Asians",legend = FALSE,homebutton =TRUE)+
  mapview(blacks_df, map.types =  "OpenStreetMap.DE",cex="lq_blacks", zcol="lq_blacks", layer.name= "Blacks",legend = FALSE,homebutton =TRUE)+
  mapview(whites_df, map.types =  "OpenStreetMap.DE",cex="lq_Whites", zcol="lq_Whites", layer.name= "Whites",legend = FALSE,homebutton =TRUE)
...
Asians are primarily migrating towards College towns and tech hub markets,The top five destinations are: Ithaca, NY home to Cornell University which is routinely ranked among the world's best universities. 	

Lafayette-West Lafayette, IN, MSA home of Perdue University which is a major research institution known for discoveries in science, technology, engineering and math.  

San Jose-Sunnyvale-Santa Clara MSA, an area with world wide recognition as a hub for technology sector. 

Ann Arbor, Michigan an area home to the University of Michigan which is considered to  be one of the top public research universities in the country and it is a leader in various fields, including medicine.
Seattle-Tacoma-Bellevue MSA, another area with increasingly important activity in the tech sector, with a labor market linked to sillicon Valley companies such as Microsoft, amazon, Facebook and google.

For the black population the highest relative concentrations of out of state migrants are mostly found in Military related towns:  Hinesville, GA, Killeen-Temple, TX, Clarksville, TN, Lawton, OK, which is in close proximity to military operations base Fort Sill, which is one of the four locations for Army Basic Combat Training. Columbus, GA area that that host Fort Moore, the United States Army's maneuver center of excellence and a major employer, is located south of the city in southern Muscogee and Chattahoochee counties. It supports more than 120,000 active-duty military, family members, reserve component soldiers, retirees and civilian employees on a daily basis.


Concerning the White non Hispanic population it is interesting to note the places that are the least preferred to migrate. The top 5 MSA in this regard  lay right at the US-Mexico Border. With Laredo, Tx, being the MSA with the lowest concentration of out of state white movers, Foolowed by the 	
Brownsville-Harlingen, TX, MSA, Madera, CA, 	
McAllen-Edinburg-Mission, Tx and 	
Vineland-Bridgeton, New Jersey, this last destination characterized by its concentration pf black population. 
...
The main  Metropolitan areas destinations for Californiasns during the study period were:  Phoenix-Mesa-Chandler, AZ, Las Vegas-Henderson-Paradise, NV, Boise City, ID,  Denver-Aurora-Lakewood, CO and Houston-The Woodlands-Sugar Land, TX. Whereas the top local (within state) destinations were:  Riverside-San Bernardino-Ontario, 
