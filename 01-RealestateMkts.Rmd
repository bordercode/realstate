...
Although this approach provides an nation wide perspective it is necessary to capture a base trend that then can be examined using a detailed geographic scale. 
