...
**Figure 5 Real estate at market value and rising equity 1980-2023** [See F5a](../speech/F5_dy1.html), [See F5b](../speech/F5_dy1.html)
```{r, echo=FALSE}
# Plots.
## Rising equity 
## loading data 
...
[Figure 6 HPI by state 2006](../speech/F6_hpi.html)
...
[Figure 9. Top 20 Metropolitan Areas. Investment Home loans 2022-Q1](../speech/F9_invest.html)
...
ggplotly(inv_plot)%>%
  layout(legend = list(orientation = "h", x = 0, y = -.05), annotations =  list(x = 1, y = -0.1, text = "Source: José Luis Manzanares  based on Single-Family Loan-Level 2022Q1 (Freddie Mac Home, 2023) data",  showarrow = F, xref='paper', yref='paper', 
      xanchor='right', yanchor='auto', xshift=0, yshift=0,
      font=list(size=7, color="#17202A")))

#htmlwidgets::saveWidget(widget = invplotly, #the plotly object file = "C:/Users/josel/Desktop/on/I/2023/HOUSING/realstate/speech/F9_invest.html", #the path & file name selfcontained = TRUE 
