...
[Figure 2 Regional price parities (RPP) by state 2022](../speech/F2map.html).
...
In accordance with conventional economic theory, a fundamental factor influencing the overall fluctuations in the aggregate price level is the cost of borrowing, formaly known as the interest rate. Interest rates are a core instrument of monetary policy that play a pivotal role in shaping economic dynamics and has significant implications for various sectors of the economy, including real estate markets. 
...
To capture the effects of this economic determinants on the housing markets,  we proposed to analyze google search data. We compare the search frequency overtime for specific termns related to the housing market, this novel approach captures  the broader social dimension that just raw economic indicators ca not uncover. 

The following analysis contains the trend for google score for terms:  "affordable home", "foreclosure" and "eviction". This terms are then plotted against the macroeconomic policy threshold dates and  external shocks events. Results are shown by figures xxx
...
Considering evidence on real state market prices in Californian MSA, labor market conditions and well as supply and demand exogenous shocks the analysis suggest that search for affordability  is one of the reasons why some people have decided to relocate out of state  or even to make the move across the border. 
...
**Figure 6 Real estate at market value and rising equity 1980-2023** [See F6a](../speech/F6_dy1.html), [See F6b](../speech/F6_dy2.html)
...
In addition, detailed mortgage records kept by governmet sponsored enterprises such as Freddie Mac and Fannie Mae, allow to distinguish the type of loan granted to actual current mortgage clients, this data is important to show real estate investment trends across Metropolitan areas. 

Nationwide 87.3% of FM clients are paying the loan for a house that is a primary residence. Almost 4% of  Freddie Mac home buyers are buying a secondary home.  And 8.9% are paying a home loan  classified as investment. 

If we think of second home loans as a proxy for social status, say, better off household get this type of loan, then the  families in the states of  Virginia, Vermont, Delaware  Maine and Florida are the places were this type of families mostly live. 

Figure 6  below ranks metro MSAs by the number of loans classified as investment by Freddie Mac single family loan data for the first quarter of 2022 [@freddiemachomeSingleFamilyLoanLevel2023]. 

[Figure 6. Top 20 Metropolitan Areas. Investment Home loans 2022-Q1](../speech/F9_invest.html)
...
# htmlwidgets::saveWidget(widget = f6, #the plotly object 
                       # file = "C:/Users/josel/Desktop/on/I/2023/HOUSING/realstate/speech/F6_invest.html", 
...
The information above for  loan category: investment,  indicates which metropolitan areas are conceived as dynamic real estate areas. It is found that The Phoenix-Mesa-Scottsdale Arizona MSA, shows the highest investment property type of loans in the US for data on the firts quarter of 2022.  
...
Lets now analyze from a geographic perspective, how real estate markets behave during this economic policy changes.

Figure 6 below shows a national perspective for the distribution of home price index at a moment before the implementation of a dovish monetary policy. 


[Figure 7 HPI by state 2006](../speech/F6_hpi.html)
...
[Figure 7 HPI by state 2023](../speech/F7_hpi23.html)
```{r,echo=FALSE, warning=FALSE, message=FALSE}
...
[Figure 8 HPI by state evolution over time 1975-2022](../speech/F8_hpi.html)
...
labs(title = "House price index, population and Income 2020. MSA at Border states 2020", x = 'Per capita personal income 2020', y = 'HPI 1991=100', colour = "state", size="HPI", caption="Source: Federal Housing Finance Agency. 2023") +
...
```{r, echo= FALSE, fig.width=10, fig.height=8, message=FALSE, Warnig=FALSE}
## Making the animated line plot
library(magick)
evolution <- image_read("border_HPI_evolution.gif")
evolution
```
