...
```{r, echo=FALSE, warning=FALSE,message=FALSE, fig.height = 7, fig.width = 9.4}
...
```{r,  warning=FALSE, message=FALSE, echo=FALSE, fig.height = 6.5, fig.width = 8}
...
```{r,echo=FALSE, fig.height = 6, fig.width = 9.4}
...
```{r, echo=FALSE, fig.height = 6.3, fig.width = 9.5}
...
[Figure 4 Monetary policy: The federal Funds Effective reate evolution July 2000  May 2023](../speech/F4_FFER.html)
```{r, echo = FALSE, fig.height = 6, fig.width = 9.4}
...
htmlwidgets::saveWidget(
  widget = invplotly, #the plotly object
  file = "C:/Users/josel/Desktop/on/I/2023/HOUSING/realstate/speech/inve.html", #the path & file name
