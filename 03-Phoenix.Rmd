# Feeling the heat: The California-Maricopa route, in search for affordable housing.
...
In this chapter, the aim is to analyze how regional migration flows from California have search to new destinations, particularly to Metropolitan areas in the south west states such as the Phoenix Metropolitan area, contributing to its recent development. 
...
In addition to supply side housing data, taxation information comes from the Internal Revenue Service (IRS) records. In this conceptual strategy, Tax data represent a complementary view of population movements.  In order to approximate migration, the IRS records year-to-year address changes reported on individual income tax returns filed and documented by IRS Form 1040. 
